...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index3 = __webpack_require__(279);
	...
	!_asyncToGenerator(function* () {
	  ...
	  const store = yield (0, _store.storeFactory)({ initialState: window.STORE_STATE });
	  ...
	  (0, _reactRouter.match)({ history: history, routes: _index4.default }, function (error, redirectLocation, renderProps) {
	  ...
	  if ((undefined) !== 'production' && _deprecateObjectProperties.canUseMembrane) {
	    ...
	    var _loop = function (prop) {
	      ...
	      Object.defineProperty(nextStateWithLocation, prop, {
	        get: function get() {
	          (undefined) !== 'production' ? _routerWarning2['default'](false, 'Accessing location properties from the first argument to `getComponent` and `getComponents` is deprecated. That argument is now the router state (`nextState`) rather than the location. To access the location, use `nextState.location`.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	let storeFactory = exports.storeFactory = (() => {
	  var ref = _asyncToGenerator(function* (_ref) {
	    let initialState = _ref.initialState;
	
	    const middleware = (0, _redux.applyMiddleware)(_reduxPromise2.default);
	    const enhancer = (0, _redux.compose)(middleware, devTools());
	    const store = (0, _redux.createStore)(_reducer2.default, initialState, enhancer);
	    return store;
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todos = __webpack_require__(272);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.reducer = exports.updateTodo = exports.addTodo = exports.initialState = exports.UPDATE_TODO = exports.ADD_TODO = undefined;
	
	var _reduxActions = __webpack_require__(273);
	...
	const UPDATE_TODO = exports.UPDATE_TODO = 'UPDATE_TODO';
	...
	const addTodo = exports.addTodo = (0, _reduxActions.createAction)(ADD_TODO);
	const updateTodo = exports.updateTodo = (0, _reduxActions.createAction)(UPDATE_TODO, (todo, update) => ({ todo: todo, update: update }));
	...
	const reducer = exports.reducer = (0, _reduxActions.handleActions)({
	  ...
	  [ADD_TODO]: (state, action) => Object.assign({}, state, { todos: state.todos.concat(action.payload) }),
	
	  [UPDATE_TODO]: (state, action) => {
	    var _action$payload = action.payload;
	    const todo = _action$payload.todo;
	    const update = _action$payload.update;
	
	    const todos = state.todos.map(todoCand => todoCand === todo ? Object.assign({}, todoCand, update) : todoCand);
	    return Object.assign({}, { todos: todos });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(274);
	
	var _createAction2 = _interopRequireDefault(_createAction);
	
	var _handleAction = __webpack_require__(275);
	
	var _handleAction2 = _interopRequireDefault(_handleAction);
	
	var _handleActions = __webpack_require__(276);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(277);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(278);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/todos', component: _Container2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const AppContainer = (0, _reactRedux.connect)(mapStateToProps)(App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(289),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Todo = __webpack_require__(295);
	...
	const component = _ref => {
	  let todos = _ref.todos;
	  let addTodo = _ref.addTodo;
	  let updateTodo = _ref.updateTodo;
	  ...
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement('input', { onKeyUp: textChange }),
	    _react2.default.createElement(
	      'ul',
	      null,
	      todos.map((todo, index) => (0, _Todo2.default)({ todo: todo, updateTodo: updateTodo }))
	    )
	  );
	};
	...
	const mapDispatchToProps = dispatch => ({
	  addTodo: text => dispatch((0, _todos.addTodo)({ text: text })),
	  updateTodo: (todo, update) => dispatch((0, _todos.updateTodo)(todo, update))
	});
	
	const Container = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Todo(_ref) {
	  ...
	  return _react2.default.createElement(
	    "li",
	    { key: Math.random() },
	    _react2.default.createElement("input", { name: "done", type: "checkbox", checked: todo.done, onChange: todoToggleDone }),
	    todo.text
	  );
	}
