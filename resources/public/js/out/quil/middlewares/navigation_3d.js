...
var vec__33694 = axis;
var a_x = cljs.core.nth.call(null,vec__33694,(0),null);
var a_y = cljs.core.nth.call(null,vec__33694,(1),null);
var a_z = cljs.core.nth.call(null,vec__33694,(2),null);
var vec__33695 = v;
var x = cljs.core.nth.call(null,vec__33695,(0),null);
var y = cljs.core.nth.call(null,vec__33695,(1),null);
var z = cljs.core.nth.call(null,vec__33695,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__33696,p__33697){
var vec__33700 = p__33696;
var u1 = cljs.core.nth.call(null,vec__33700,(0),null);
var u2 = cljs.core.nth.call(null,vec__33700,(1),null);
var u3 = cljs.core.nth.call(null,vec__33700,(2),null);
var vec__33701 = p__33697;
var v1 = cljs.core.nth.call(null,vec__33701,(0),null);
var v2 = cljs.core.nth.call(null,vec__33701,(1),null);
var v3 = cljs.core.nth.call(null,vec__33701,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__33702_SHARP_){
return (p1__33702_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__33703_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__33704_SHARP_,angle_lr),angle_ud);
...
var map__33711 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__33711__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__33711__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__33713 = cljs.core._EQ_;
var expr__33714 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__33713.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__33714))){
return straight;
} else {
if(cljs.core.truth_(pred__33713.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__33714))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__33713.call(null,quil.middlewares.navigation_3d.space,expr__33714))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__33713.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__33714))){
return up;
} else {
if(cljs.core.truth_(pred__33713.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__33714))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__33713.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__33714))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__33711,map__33711__$1,up,straight){
return (function (p1__33705_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__33705_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__33711,map__33711__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__33716_SHARP_);
});})(initial_state))
);
});
/**
...
var map__33722_33727 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__33722_33728__$1 = ((((!((map__33722_33727 == null)))?((((map__33722_33727.cljs$lang$protocol_mask$partition0$ & (64))) || (map__33722_33727.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33722_33727):map__33722_33727);
var vec__33723_33729 = cljs.core.get.call(null,map__33722_33728__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_33730 = cljs.core.nth.call(null,vec__33723_33729,(0),null);
var c_y_33731 = cljs.core.nth.call(null,vec__33723_33729,(1),null);
var c_z_33732 = cljs.core.nth.call(null,vec__33723_33729,(2),null);
var vec__33724_33733 = cljs.core.get.call(null,map__33722_33728__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_33734 = cljs.core.nth.call(null,vec__33724_33733,(0),null);
var u_y_33735 = cljs.core.nth.call(null,vec__33724_33733,(1),null);
var u_z_33736 = cljs.core.nth.call(null,vec__33724_33733,(2),null);
var vec__33725_33737 = cljs.core.get.call(null,map__33722_33728__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_33738 = cljs.core.nth.call(null,vec__33725_33737,(0),null);
var p_y_33739 = cljs.core.nth.call(null,vec__33725_33737,(1),null);
var p_z_33740 = cljs.core.nth.call(null,vec__33725_33737,(2),null);
quil.core.camera.call(null,p_x_33738,p_y_33739,p_z_33740,(p_x_33738 + c_x_33730),(p_y_33739 + c_y_33731),(p_z_33740 + c_z_33732),u_x_33734,u_y_33735,u_z_33736);
