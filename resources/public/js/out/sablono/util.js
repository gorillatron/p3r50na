...
var x__19564__auto__ = (((x == null))?null:x);
var m__19565__auto__ = (sablono.util.to_str[goog.typeOf(x__19564__auto__)]);
if(!((m__19565__auto__ == null))){
return m__19565__auto__.call(null,x);
} else {
var m__19565__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19565__auto____$1 == null))){
return m__19565__auto____$1.call(null,x);
} else {
...
var x__19564__auto__ = (((x == null))?null:x);
var m__19565__auto__ = (sablono.util.to_uri[goog.typeOf(x__19564__auto__)]);
if(!((m__19565__auto__ == null))){
return m__19565__auto__.call(null,x);
} else {
var m__19565__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19565__auto____$1 == null))){
return m__19565__auto____$1.call(null,x);
} else {
...
var len__19967__auto___22428 = arguments.length;
var i__19968__auto___22429 = (0);
while(true){
if((i__19968__auto___22429 < len__19967__auto___22428)){
args__19974__auto__.push((arguments[i__19968__auto___22429]));

var G__22430 = (i__19968__auto___22429 + (1));
i__19968__auto___22429 = G__22430;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19975__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq22427){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq22427));
});
/**
...
var vec__22432 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__22432,(0),null);
var words = cljs.core.nthnext.call(null,vec__22432,(1));
...
var G__22434 = clojure.set.rename_keys.call(null,m,kmap);
var G__22434__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__22434,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__22434);
return G__22434__$1;
} else {
return m;
}
...
var args__19974__auto__ = [];
var len__19967__auto___22437 = arguments.length;
var i__19968__auto___22438 = (0);
while(true){
if((i__19968__auto___22438 < len__19967__auto___22437)){
args__19974__auto__.push((arguments[i__19968__auto___22438]));

var G__22439 = (i__19968__auto___22438 + (1));
i__19968__auto___22438 = G__22439;
continue;
} else {
}
break;
...
var argseq__19975__auto__ = ((((0) < args__19974__auto__.length))?(new cljs.core.IndexedSeq(args__19974__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__19975__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__22435_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__22435_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__22435_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__22435_SHARP_)){
return p1__22435_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__22435_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq22436){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq22436));
});
/**
...
var vec__22443 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__22443,(0),null);
var names = cljs.core.nth.call(null,vec__22443,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__22443,tag_name,names){
return (function (p1__22440_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__22440_SHARP_));
});})(matches,vec__22443,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__22443,tag_name,names){
return (function (p1__22441_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__22441_SHARP_));
});})(matches,vec__22443,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__22444){
var vec__22447 = p__22444;
var tag = cljs.core.nth.call(null,vec__22447,(0),null);
var content = cljs.core.nthnext.call(null,vec__22447,(1));
...
var vec__22448 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__22448,(0),null);
var id = cljs.core.nth.call(null,vec__22448,(1),null);
var class$ = cljs.core.nth.call(null,vec__22448,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18928__auto__ = x__$1.hasDomain();
