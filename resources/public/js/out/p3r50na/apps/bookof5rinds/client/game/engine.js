...
var map__23840 = new cljs.core.Keyword(null,"player","player",-97687400).cljs$core$IFn$_invoke$arity$1(state);
...
var x = cljs.core.get.call(null,map__23840__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__23840__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var speed = cljs.core.get.call(null,map__23840__$1,new cljs.core.Keyword(null,"speed","speed",1257663751));
var newstate = cljs.core.reduce.call(null,((function (map__23840,map__23840__$1,x,y,speed){
return (function (state__$1,controll){
var newstate = (function (){var G__23842 = (((controll instanceof cljs.core.Keyword))?controll.fqn:null);
switch (G__23842) {
case "up":
...
});})(map__23840,map__23840__$1,x,y,speed))
,state,controlls);
return newstate;
}
});
...
var speed = cljs.core.get.call(null,map__23848__$1,new cljs.core.Keyword(null,"speed","speed",1257663751));
var vec__23849 = cljs.core.get.call(null,map__23848__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var bx = cljs.core.nth.call(null,vec__23849,(0),null);
var by = cljs.core.nth.call(null,vec__23849,(1),null);
var lx = cljs.core.get.call(null,map__23848__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var ly = cljs.core.get.call(null,map__23848__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var vec__23850 = cljs.core.get.call(null,map__23848__$1,new cljs.core.Keyword(null,"goal","goal",-2073396501));
var gx = cljs.core.nth.call(null,vec__23850,(0),null);
var gy = cljs.core.nth.call(null,vec__23850,(1),null);
var dx = (gx - bx);
var dy = (gy - by);
...
var mx = cljs.core.get.call(null,map__23856__$1,new cljs.core.Keyword(null,"mx","mx",-199887020));
var my = cljs.core.get.call(null,map__23856__$1,new cljs.core.Keyword(null,"my","my",-1055703269));
var map__23857 = new cljs.core.Keyword(null,"player","player",-97687400).cljs$core$IFn$_invoke$arity$1(state);
...
var px = cljs.core.get.call(null,map__23857__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var py = cljs.core.get.call(null,map__23857__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var ps = cljs.core.get.call(null,map__23857__$1,new cljs.core.Keyword(null,"size","size",1098693007));
...
var G__23861 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(event);
switch (G__23861) {
...
var initial_state = cljs.core.merge.call(null,state,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bullets","bullets",1734809024),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"controlls","controlls",-310267444),cljs.core.PersistentHashSet.EMPTY], null));
